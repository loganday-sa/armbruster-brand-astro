---
title: "State AI Laws Are Crushing Small Businesses"
description: "States passed 145 AI laws in 2025. PerceptIn budgeted $10K, spent $344K, went under. Here's how to survive without bankruptcy."
...
Wrong. And this is before you factor in the strategic costs of [choosing the wrong AI tools](/ai-strategy/why-your-ai-strategy-is-backwards-and-how-to-fix-it/) in the first place.
...
After watching dozens of businesses navigate this mess, I've developed a compliance approach that actually works without bankrupting you. Before diving into compliance specifics, make sure you're actually [implementing AI correctly](/implementation/ai-implementation-guide-bridge-learning-to-real-results/)—there's no point in complying with regulations for systems that don't deliver results.
...
Here's the uncomfortable truth: regulatory compliance is now a core part of AI ROI calculations. That's why [asking the right questions before implementing AI](/ai-strategy/the-5-question-checklist-that-makes-ai-worth-it-for-small-businesses/) matters more than ever—compliance costs can kill projects that barely pass the ROI threshold.
